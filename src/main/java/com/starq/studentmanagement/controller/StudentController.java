package com.starq.studentmanagement.controller;
...
public class StudentController {
    ...
    //since thi is spring mvc, this method is to handle listing of all students and return model and view 
    ...
    @PostMapping("/students/delete-student/{id}")
